...
async def delayed_delete(message, context, delay=10):
    """
    Deleta uma mensagem após um delay, a menos que esteja protegida.
    """
...
async def send_and_delete(
    ...
    """
    Envia uma mensagem e deleta tanto ela quanto a mensagem anterior (texto ou botão).
    """
...
async def enviar_documento_temporario(context, chat_id, document_bytes, filename, caption, timeout=120):
